...
export default function PreviewModal({ name, id }: any) {
  const [showModal, setShowModal] = React.useState(false);

  return (
    <>
      <button
        className="mr-2 mb-4 flex cursor-pointer items-center justify-center rounded-md bg-red-600 py-2 px-8 text-center text-white transition duration-150 ease-in-out  hover:bg-red-600"
        type="button"
